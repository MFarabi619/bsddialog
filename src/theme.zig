...
pub fn apply_orangey_black() !void {
    ...
    theme.screen.color = color(c.BSDDIALOG_BLACK, c.BSDDIALOG_BLACK, 0);
    ...
    theme.dialog.delimtitle = true;
    theme.dialog.titlecolor = color(c.BSDDIALOG_RED, c.BSDDIALOG_BLACK, c.BSDDIALOG_BOLD);
    ...
    theme.menu.f_prefixcolor = color(c.BSDDIALOG_RED, c.BSDDIALOG_BLACK, 0);
    ...
    theme.menu.bottomdesccolor = color(c.BSDDIALOG_BLACK, c.BSDDIALOG_YELLOW, 0);
    theme.menu.sepnamecolor = color(c.BSDDIALOG_RED, c.BSDDIALOG_YELLOW, 0);
    theme.menu.sepdesccolor = color(c.BSDDIALOG_RED, c.BSDDIALOG_YELLOW, 0);

    theme.form.f_fieldcolor = color(c.BSDDIALOG_BLACK, c.BSDDIALOG_YELLOW, c.BSDDIALOG_BOLD);
    theme.form.fieldcolor = color(c.BSDDIALOG_BLACK, c.BSDDIALOG_YELLOW, c.BSDDIALOG_BOLD);
    theme.form.readonlycolor = color(c.BSDDIALOG_RED, c.BSDDIALOG_YELLOW, c.BSDDIALOG_BOLD);
    theme.form.bottomdesccolor = color(c.BSDDIALOG_BLACK, c.BSDDIALOG_YELLOW, 0);

    theme.bar.f_color = color(c.BSDDIALOG_BLACK, c.BSDDIALOG_YELLOW, c.BSDDIALOG_BOLD);
    theme.bar.color = color(c.BSDDIALOG_YELLOW, c.BSDDIALOG_RED, c.BSDDIALOG_BOLD);

    theme.button.minmargin = 1;
    theme.button.maxmargin = 5;
    theme.button.leftdelim = '[';
    theme.button.rightdelim = ']';
    theme.button.f_delimcolor = color(c.BSDDIALOG_BLACK, c.BSDDIALOG_YELLOW, 0);
    theme.button.delimcolor = color(c.BSDDIALOG_YELLOW, c.BSDDIALOG_BLACK, 0);
    theme.button.f_color = color(c.BSDDIALOG_BLACK, c.BSDDIALOG_YELLOW, 0);
    theme.button.color = color(c.BSDDIALOG_YELLOW, c.BSDDIALOG_BLACK, 0);
    theme.button.f_shortcutcolor = color(c.BSDDIALOG_RED, c.BSDDIALOG_YELLOW, c.BSDDIALOG_BOLD);
